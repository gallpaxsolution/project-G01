    ...
    <Box>
      <Container maxWidth="xl" style={{ marginTop: "20px" }}>
        ...
        <Grid container spacing={2}>
          ...
          {/* <Grid item xs={6} md={4} style={{ height: "295px" }}>
                ...
                >
                  ...
                  >
                    <Box style={{ display: "flex", gap: "15px" }}>
                      <Tab style={{ backgroundColor: "#003566" }}>
                        All {searchCount?.allsearch}
                      </Tab>
                      <Tab
                        style={{ backgroundColor: "#8a5138", color: "#fff" }}
                      >
                        Top
                      </Tab>
                      <Tab style={{ backgroundColor: "#DC143C" }}>
                        One Way {searchCount?.oneway}
                      </Tab>
                      <Tab style={{ backgroundColor: "#089326" }}>
                        Round Way {searchCount?.return}
                      </Tab>
                      <Tab style={{ backgroundColor: "#DC14A4" }}>
                        Agency {searchCount?.agentwise?.length}
                      </Tab>
                    </Box>
                  </TabList>
