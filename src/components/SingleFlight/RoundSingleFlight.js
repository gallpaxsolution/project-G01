                          ...
                          {segment === "3" ? (
                            ...
                            <Box className="roundsegment-2">
                              ...
                              >
                                ...
                                >
                                  {
                                    segments.go[2]?.arrivalLocation?.split(
                                      ","
                                    )[0]
                                  }
                                </Typography>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <Box className="flight-content-detail">
                                      ...
                                      <h5>
                                        {segments.go[1]?.departureLocation}
                                      </h5>
                                      <h5>
                                        {format(
                                          new Date(
                                            segments.go[1]?.departureTime
                                          ),
                                          "dd MMM yyyy hh:mm a"
                                        )}
                                      </h5>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <Box className="flight-content-detail">
                                      ...
                                      <h5>
                                        {segments.go[2]?.departureLocation}
                                      </h5>
                                      <h5>
                                        {format(
                                          new Date(
                                            segments.go[2]?.departureTime
                                          ),
                                          "dd MMM yyyy hh:mm a"
                                        )}
                                      </h5>
                          ...
                          <Box className="warning-box">
                            <Typography fontSize={"12px"} className="alert">
                              *Important: This destination may have COVID-19
                              ...
                              restriction for loading. Check any nation,local
                              and health advisories for this destination before
                              you book.
                            </Typography>
                          </Box>
                        </TabPanel>
                    ...
                    {customerFare && (
                      <>
                        ...
                        <Box
                          sx={{
                            borderBottom:
                              "0.5px solid rgba(209, 233, 255, 0.52)",
                          }}
                        ></Box>
                      </>
                    )}
